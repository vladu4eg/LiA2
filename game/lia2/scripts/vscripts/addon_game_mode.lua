...
function Precache( context )
		...
		--Книга Мертвых
		PrecacheModel("models/items/clinkz/demonspinerecurve_lod1/demonspinerecurve_lod1.vmdl", context)
		PrecacheModel("models/items/clinkz/clinkz_hands_goc/clinkz_hands_goc.vmdl", context)
		PrecacheModel("models/items/clinkz/clinkz_shoulders_goc/clinkz_shoulders_goc.vmdl", context)
		PrecacheModel("models/items/clinkz/clinkz_helmet01_goc/clinkz_helmet01_goc.vmdl", context)
		PrecacheModel("models/heroes/clinkz/clinkz_head.vmdl", context)	
		PrecacheModel("models/heroes/clinkz/clinkz.vmdl", context)	
		PrecacheModel("models/heroes/clinkz/clinkz_back.vmdl", context)			
		...
		PrecacheModel("models/heroes/troll_warlord/troll_warlord_axe_ranged_l.vmdl", context)	
		PrecacheModel("models/heroes/troll_warlord/troll_warlord_axe_ranged_r.vmdl", context)			
		...
		PrecacheModel("models/items/doom/impending_transgressions_back/impending_transgressions_back.vmdl", context)
		PrecacheModel("models/items/doom/crown_of_omoz/crown_of_omoz.vmdl", context)
		PrecacheModel("models/items/doom/weapon_eyeoffetitzu/weapon_eyeoffetitzu.vmdl", context)
		PrecacheModel("models/items/doom/impending_transgressions_arms/impending_transgressions_arms.vmdl", context)	
		PrecacheModel("models/items/doom/impending_transgressions_tail/impending_transgressions_tail.vmdl", context)	
		PrecacheModel("models/items/doom/impending_transgressions_shoulders/impending_transgressions_shoulders.vmdl", context)
		PrecacheModel("models/items/doom/impending_transgressions_belt/impending_transgressions_belt.vmdl", context)	
