...
LinkLuaModifier( "modifier_test_no_cooldown", "survival/modifier_test_no_cooldown.lua", LUA_MODIFIER_MOTION_NONE )
...
function LiA:InitGameMode()
    ...
    GameMode:SetCustomAttributeDerivedStatValue(DOTA_ATTRIBUTE_INTELLIGENCE_DAMAGE,1.5)
    ...
    GameMode:SetHealingFilter( Dynamic_Wrap( LiA, "FilterHealing" ), self )
