...
function CleanUnitsOnMap()
	local units = FindUnitsInRadius(DOTA_TEAM_GOODGUYS + DOTA_TEAM_CUSTOM_1, Vector(0,0,0), nil, 9999, DOTA_UNIT_TARGET_TEAM_BOTH, DOTA_UNIT_TARGET_ALL, DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES+DOTA_UNIT_TARGET_FLAG_INVULNERABLE--[[+DOTA_UNIT_TARGET_FLAG_OUT_OF_WORLD]], FIND_ANY_ORDER, true)
